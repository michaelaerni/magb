...
public class Ikosa4 extends GLBase1
{
     ...
     float ambient = 0.2f, diffuse = 0.8f;        // Parameter fuer Helligkeitsberechnung


     //  ------  Ikosaeder-Ecken  ----------
     float X=0.525731112119133606f;
     float Z=0.850650808352039932f;
     Vec3[] vdata={ new Vec3(-X, 0, Z), new Vec3(X, 0, Z), new Vec3(-X, 0, -Z), new Vec3(X, 0, -Z),
     ...
     {  GL3 gl = drawable.getGL().getGL3();
        ...
        setLightPosition(gl, lightPosition);
        setColor(0, 1, 1);
